public class Edge
{
  ...
  public Edge(Gradients gradients, Vertex minYVert, Vertex maxYVert, int minYVertIndex)
  {
    ...
    m_depthStep = gradients.GetDepthYStep() +
        gradients.GetDepthXStep() * m_xStep;

    m_depth = gradients.GetLightAmt(minYVertIndex) +
        gradients.GetLightAmtXStep() * xPrestep +
        gradients.GetLightAmtYStep() * yPrestep;
    m_depthStep = gradients.GetLightAmtYStep() +
        gradients.GetLightAmtXStep() * m_xStep;
